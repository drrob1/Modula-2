...
(* For whatever reason, including ES_USER_PRESENT does not work. *)      
      esPrevFlags  := WIN32.SetThreadExecutionState
                    ( ES_CONTINUOUS BOR ES_DISPLAY_REQUIRED BOR ES_SYSTEM_REQUIRED );
