...
PROCEDURE PreviousNextFromStringItem(StringListP: StringDoubleLinkedListPointerType; 
                                     VAR OUT previous, next : ADDRESS);
BEGIN
  previous := StringListP^.CurrentPlaceInList^.Prev;
  next := StringListP^.CurrentPlaceInList^.Next;
