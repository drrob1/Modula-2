...
VAR
  ...
  WiggleMouse     : INTEGER = TimeToWiggleMouse;
(*
...
BEGIN
    ...
    TWM_CLOSE:
        ...
        RETURN OkayToClose;
    | TWM_CREATE:
        FUNC SetWindowIcon(tw, SS4Icon16);
        ch1 := 'a';
        ch2 := 0c;
        ch3 := 0c;
        str1 := '';
...
*)
    Win := CreateWindow(NIL, (* parent : WinShell.Window *)
                        "SS4 Dancing Mouse TW", (* name : ARRAY OF CHAR *)
                        "",        (* menu : ARRAY OF CHAR *)
                        SS4Icon16, (* icon : ARRAY OF CHAR *)
