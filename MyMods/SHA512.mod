...
FROM SYSTEM IMPORT
    BYTE, ADDRESS, BIGENDIAN, ADR, ADDADR;
...
*)
PROCEDURE a(VAR INOUT T : DigestType; i : CARDINAL) : WordType [INLINE];
BEGIN
    RETURN T[(0-i) BAND 7];
END a;

PROCEDURE b(VAR INOUT T : DigestType; i : CARDINAL) : WordType [INLINE];
BEGIN
    RETURN T[(1-i) BAND 7];
END b;

PROCEDURE c(VAR INOUT T : DigestType; i : CARDINAL) : WordType [INLINE];
BEGIN
    RETURN T[(2-i) BAND 7];
END c;

PROCEDURE d(VAR INOUT T : DigestType; i : CARDINAL) : WordType [INLINE];
BEGIN
    RETURN T[(3-i) BAND 7];
END d;

PROCEDURE e(VAR INOUT T : DigestType; i : CARDINAL) : WordType [INLINE];
BEGIN
    RETURN T[(4-i) BAND 7];
END e;

PROCEDURE f(VAR INOUT T : DigestType; i : CARDINAL) : WordType [INLINE];
BEGIN
    RETURN T[(5-i) BAND 7];
END f;

PROCEDURE g(VAR INOUT T : DigestType; i : CARDINAL) : WordType [INLINE];
BEGIN
    RETURN T[(6-i) BAND 7];
END g;

PROCEDURE h(VAR INOUT T : DigestType; i : CARDINAL) : WordType [INLINE];
BEGIN
    RETURN T[(7-i) BAND 7];
END h;
