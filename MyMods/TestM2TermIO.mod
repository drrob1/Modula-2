...
IMPORT Terminal, BasicDialogs,WholeStr,LongStr;
...
BEGIN
  ...
  | WINUSER.WM_CREATE :
      ...
      WINGDI.TextOut (hdc, 0, 0,'Hello from WM_CREATE',18);
  ...
  | WINUSER.WM_SIZE :
       ...
       Terminal.Reset;
       Terminal.WriteString(' In Terminal WriteString.');
       Terminal.WriteLn;
       RETURN 0;
  | WINUSER.WM_VSCROLL :
  ...
  | WINUSER.WM_COMMAND:
      ...
      WINGDI.TextOut (hdc, 0, 0,'Hello from WM_COMMAND',21);
      BasicDialogs.MessageBox('Hello from WM_Command Message.',MsgInfo);
